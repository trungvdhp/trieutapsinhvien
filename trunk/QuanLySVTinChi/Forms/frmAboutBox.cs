...
namespace TrieuTapSinhVien
{
    partial class frmAboutBox : Form
    {
        ...
        public string AssemblyVersion
        {
            get
            {
                return String.Format("{0}.{1:0}", Assembly.GetExecutingAssembly().GetName().Version.Major, Assembly.GetExecutingAssembly().GetName().Version.Minor);
            }
        }
        ...
        {
            System.Diagnostics.Process.Start("http://hanghaicnt.net");
        }
        ...
        {
            System.Diagnostics.Process.Start("http://fit.vimaru.edu.vn");
        }

        private void labelCompanyName_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("http://vimaru.edu.vn");
        }
        #endregion  
    }
}
